...
<header class="header-top">
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="#"><img class="dark" src="{{asset('images/logoEduTrack.png')}}" alt="svg"><img
                    class="light" src="{{asset('images/logoEduTrack.png')}}" alt="img"></a>
                        ...
                        <div class="dropdown-custom">
                            ...
                            <div class="dropdown-wrapper">
                                ...
                                <div class="nav-author__options">
                                    ...
                                    <a href="{{route('enseignant.logout')}}" class="nav-author__signout">
