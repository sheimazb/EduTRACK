    ...
    <div class="sidebar sidebar-collapse" id="sidebar">
        <div class="sidebar__menu-group">
            <ul class="sidebar_nav">
                ...
                <li class="">
                    <a href="{{route('enseignant.dashboard')}}" class="">
                ...
                <li class="">
                    <a href="{{route('enseignant.liste.classes')}}" class="">
                        ...
                        <span class="menu-text">Mes classes</span>
                        </span>
                    </a>
                </li>
                <li class="has-child">
                    ...
                    <ul>
                        <li>
                            <a href="{{route('enseignant.cours')}}" class="">Liste de cours <span class="badge badge-success menuItem">New</span></a>
                        </li>
                        <li>
                            <a href="{{route('enseignant.ajout.cours')}}" class="">Ajouter un cours </a>
                        </li>
                    </ul>
                </li>

                <li class="">
                    <a href="{{route('enseignant.liste.etudiant')}}" class="">
                        ...
                        <span class="menu-text">Mes etudiants</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('enseignant.chrono')}}" class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check nav-icon"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>
