        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-5 p-0">
                    <div class="signUP-admin-left signIn-admin-left position-relative" style="background-color: rgb(40,40,40);width: 650px">
                                    ...
                                    <div class="card border-0">
                                        <div class="card-header border-0  pb-md-15 pb-10 pt-md-20 pt-10 ">
                                            <div class="edit-profile__title">
                                                <h6>Login <span class="color-primary" style="color: #ffb700" >Admin</span></h6>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="edit-profile__body">
                                                ...
                                                <div class="button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                                    <button  style="background-color: #590606;" class="btn  btn-default btn-squared mr-15 text-capitalize lh-normal px-50 py-15 signIn-createBtn ">
                                                       <a href="{{route('enseignant.dashboard')}}" style="color: whitesmoke">Login</a>
                                                    </button>
                                                </div>
